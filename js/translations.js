...
const translations = {
  es: {
    ...
    webCreatedBy: 'Web creada por Joaquin L. Villanueva Farber', apiUsed: 'API usada', apisUsed: 'APIs usadas', trademarkDisclaimer: 'Pokémon y los nombres de personajes son marcas de Nintendo.', weakness: 'Debilidad',
  ...
  en: {
    ...
    pokemonInfo: 'Pokemon Information', webCreatedBy: 'Web created by Joaquin L. Villanueva Farber', apiUsed: 'API used', apisUsed: 'APIs used', trademarkDisclaimer: 'Pokémon and character names are trademarks of Nintendo.',
